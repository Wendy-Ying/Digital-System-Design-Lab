...
begin
    ...
    begin
        ...
        wait for CLK_PERIOD;
        start <= '0';
        expected_r := std_logic_vector(to_unsigned(0, 16));
        wait until ready = '1';
        ...
        wait until ready = '1';
        assert r = expected_r report "Test 3 failed: 255*255" severity error;
        ...
        wait until ready = '1';
        assert r = expected_r report "Test 4 failed: 255*1" severity error;
        ...
        expected_r := std_logic_vector(to_unsigned(255, 16));
        wait until ready = '1';
        assert r = expected_r report "Test 5 failed: 1*255" severity error;
